...
2. **Academic** — tailored for college admission and student exchange applications
...
## Academic CV (admission & exchange)

| File | Purpose |
|------|---------|
| `Bayan_Kallash_CV_Erasmus.pdf` | Ready-to-send PDF for academic applications |
...
**Admission / exchange:** Pair the academic CV with a motivation letter; be ready to discuss ECTS mapping with your home/host coordinators.
