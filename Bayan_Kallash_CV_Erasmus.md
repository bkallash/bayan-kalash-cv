...
| Area | Skills |
|------|--------|
| **Core CS** | Algorithms · Data Structures · Software Architecture · OOP · Databases · Problem Solving |
| **Languages** | PHP · JavaScript (ES6+) · HTML5 · CSS3 · SQL |
| **Engineering** | Laravel · Livewire · RESTful APIs · MVC · MySQL · Git/GitHub · Docker · Linux CLI |
| **Learning** | Self-directed study · Technical documentation · Version-controlled academic and project workflows |
