...
Software Engineering student and full-stack developer who builds reliable web applications with care and precision. Strong foundation in software architecture, databases, and algorithms, applied through **Laravel**, **PHP**, and **MySQL** across the full stack. Self-directed, fluent in English (C1), and committed to maintainable code that holds up in production. Seeking remote full-stack or backend opportunities where thoughtful engineering drives real impact.
